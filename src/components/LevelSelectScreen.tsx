...
export function LevelSelectScreen({
  ...
  return (
    <div className="flex-1 flex flex-col justify-between p-5 bg-stone-50 select-none">
      ...
      {/* Bottom Confirm */}
      <div className="border-t border-stone-300 border-dashed pt-3">
        <motion.button
          id="btn-level-select-confirm"
          whileHover={{ scale: 1.01 }}
          whileTap={{ scale: 0.98 }}
          onClick={onProceedSelected}
          className="w-full bg-black hover:bg-neutral-900 text-white font-display font-black py-3.5 px-4 text-xs tracking-widest shadow-[4px_4px_0px_#22c55e] rounded-none flex items-center justify-center gap-2 cursor-pointer active:translate-y-0.5 active:shadow-none transition-all"
        >
          <span>🚀 开始关卡</span>
